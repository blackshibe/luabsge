...
class BlankContactListener : public ContactListener
{
public:
	// See: ContactListener
...
class BlankBodyACtivationListener : public BodyActivationListener
{
public:
...
static JPH::PhysicsSystem* physics_system = nullptr;
...
void init() {
	...
	// // Remove and destroy the rigid_body
	// body_interface.RemoveBody(rigid_body->GetID());
	// body_interface.DestroyBody(rigid_body->GetID());
