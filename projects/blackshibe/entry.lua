...
World.rendering.step:connect(
	function(delta_time) -- TODO: dt is broken in the browser, TODO: buffers don't work in librewolf (<1k max texture res)
		...
		local glitch_factor = 0.01 -- + (mouse_delta.x + mouse_delta.y) / 100
		if use_shader then
			...
			glitch_effect:set_uniform_vec2("u_mouse_position", mouse_position_scaled.x, mouse_position_scaled.y)
