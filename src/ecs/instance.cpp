...
// 	lua.new_usertype<BSGEObject>("Object", sol::constructors<BSGEObject()>(),

// 	                             "add_component", [](sol::this_state state, BSGEObject &object, EcsComponentType type, const sol::table &data) { return lua_bsge_load_component(state, object, type, data); },

// 	                             "get_component", [](sol::this_state state, BSGEObject &object, EcsComponentType type) { return lua_bsge_get_component(state, object, type); },

// 	                             "patch_component", [](sol::this_state state, BSGEObject &object, EcsComponentType type, const sol::table &data) { lua_bsge_patch_component(state, object, type, data); },

// 	                             "transform", sol::property([](BSGEObject &object) -> glm::mat4 {
...
//                                         return obj_comp.transform; }, [](BSGEObject &object, glm::mat4 transform) {
//                                         entt::registry* registry = lua_bsge_get_registry();
