...
void lua_bsge_init_vfx(sol::state &lua) {
    ...
    lua.new_usertype<VFXEffectStruct>("VFXEffect",
        ...
        "load_fragment_shader", load_fragment_shader,
        "render", render,
        "set_uniform_float", set_uniform_float,
        "set_uniform_vec2", set_uniform_vec2,
        "set_uniform_vec3", set_uniform_vec3,
        "set_uniform_vec4", set_uniform_vec4,
        "set_uniform_int", set_uniform_int,
        "set_uniform_texture", set_uniform_texture,
        "set_uniform_mat4", set_uniform_mat4,
        "bind", bind,
        "unbind", unbind,
