...
VkPipelineShaderStageCreateInfo Vulkan::init::pipeline_shader_stage_create_info(VkShaderStageFlagBits stage, VkShaderModule shaderModule, const char *entry) {
...
VkPipelineLayoutCreateInfo Vulkan::init::pipeline_layout_create_info() {
